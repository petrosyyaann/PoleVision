...
export const Camera = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    <path
      d="M8.44091 5.76165C8.81422 4.17963 10.266 3 12 3C13.734 3 15.1858 4.17963 15.5591 5.76165L15.7151 5.79339C18.1003 6.27888 19.9998 8.03831 20.6215 10.3381C21.1262 12.2049 21.1262 14.1676 20.6215 16.0344C19.9998 18.3342 18.1003 20.0936 15.7151 20.5791L15.2593 20.6718C13.1095 21.1094 10.8905 21.1094 8.74072 20.6718L8.28493 20.5791C5.89969 20.0936 4.0002 18.3342 3.3785 16.0344C2.87383 14.1676 2.87383 12.2049 3.3785 10.338C4.0002 8.0383 5.89968 6.27888 8.28493 5.79339L8.44091 5.76165Z"
      stroke="white"
      stroke-width="1.5"
      stroke-linejoin="round"
    />
    <path
      d="M9.5 13C9.5 11.6193 10.6193 10.5 12 10.5C13.3807 10.5 14.5 11.6193 14.5 13C14.5 14.3807 13.3807 15.5 12 15.5C10.6193 15.5 9.5 14.3807 9.5 13Z"
      stroke="white"
      stroke-width="1.5"
    />
  </svg>
